    ...
    return(
        <footer>
            <Container>
                <div className="footer-container d-flex flex-wrap justify-content-between">
                    <div className="website-info footer-content mb-5 mb-lg-0">
                        ...
                        <div className="info mt-3">
                            ...
                            <div className="info-box d-flex mb-2">
                                ...
                                <p className='mb-0 text-dark me-1 fw-bold'>Fri</p>
                                <p className='mb-0 text-dark me-1'>from</p>
                                <p className='mb-0 text-dark me-1 fw-bold'>6am</p>
                                <p className='mb-0 text-dark me-1'>to</p>
                                <p className='mb-0 text-dark me-1 fw-bold'>7pm</p>
                                <p className='mb-0 text-dark'>PT</p>
                            </div>
                            <div className="info-box d-flex mb-3">
                                <p className='mb-0 text-dark'>8000 Haskell Ave, Van Nuys, CA 91406</p>
                            </div>
                            <div className="info-box d-flex">
                                <a href="#" className='me-3'>
                                    <FontAwesomeIcon icon={faFacebook} style={{ color: "#000", width: "28px", height: "28px" }} />
                                </a>
                                <a href="#">
                                    <FontAwesomeIcon icon={faInstagram} style={{ color: "#000", width: "28px", height: "28px" }} />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="information footer-content mb-5 mb-lg-0">
                        ...
                        <li className='d-flex'>
                            <Link to="/blog/customer-stories" className="menu-link text-dark text-decoration-none">Customer Stories</Link>
                        </li>
                        <li className='d-flex'>
                        ...
                        <li className='d-flex'>
                            <Link to="/privacy" className="menu-link text-dark text-decoration-none">Privacy Policy</Link>
                        </li>
                        <li className='d-flex'>
                    ...
                    <div className="payments footer-content mb-5 mb-lg-0">
                        <h2 className='text-dark mb-3'>Safe Payments</h2>
                        <p className='text-dark'>Our website is compatible with many popular payment methods. SSL 100% Secure Transactions.</p>
                    ...
                    <div className="newsletter footer-content">
                        <h2 className='text-dark mb-3'>Subscribe to our Newsletter!</h2>
                        <p className='text-dark'>Be among the first to learn about new products, promotions, and featured customer stories.</p>
            ...
            <div className="copyright">
                ...
                <span className="copyright-text text-center text-dark d-flex justify-content-center">
